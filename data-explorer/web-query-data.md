...
1. Копируйте и вставьте в окно запроса следующий запрос. Вверху окна выберите **Выполнить**.
    ...
    :::image type="content" source="media/web-query-data/result-set-01.png" alt-text="Снимок экрана: таблица с данными о времени начала, времени завершения, эпизоде, идентификаторе события, состоянии и типе события для десяти бурь." border="false":::
