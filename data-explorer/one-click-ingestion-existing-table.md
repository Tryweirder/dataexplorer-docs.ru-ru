...
1. Если поле **Таблица** не заполнено автоматически, выберите имя существующей таблицы из раскрывающегося меню.
    ...
    > [!NOTE]
    > Если выбрать **Ingest new data** (Прием новых данных ) в строке *таблицы*, выбранное имя таблицы появится в области **Сведения о проекте**.
...
Чтобы добавить столбцы из уровней JSON, которые отличаются от основных **уровней SON**, выбранных выше, сделайте следующее:
