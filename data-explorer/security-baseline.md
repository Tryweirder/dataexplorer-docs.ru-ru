...
[Отчеты Azure AD](/azure/active-directory/reports-monitoring/)

[Использование проверок доступа для идентификации Azure](/azure/active-directory/governance/access-reviews-overview)
