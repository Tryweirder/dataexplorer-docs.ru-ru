...
* [Отключите сетевые политики](https://docs.microsoft.com/azure/private-link/disable-private-endpoint-network-policy) , такие как группы безопасности сети (NSG). Эти группы не поддерживаются для частных конечных точек.
