...
1. Выберите **Прием данных** и **Добавить подключение к данным**. Заполните форму, указав следующую информацию. По завершении нажмите кнопку **Создать**.
    ...
    **Целевая таблица:**
    ...
    | Сопоставление столбцов | *TestMapping* | [Карта,](kusto/management/mappings.md) созданная в **TestDatabase,** которая отображает поступающие данные JSON к именам столбцов и типам данных **TestTable.** Требуется для JSON или MULTILINE JSON, и необязательно для других форматов.|
    | | |
