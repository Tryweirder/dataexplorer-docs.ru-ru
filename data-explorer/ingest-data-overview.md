...
| [**Пакет SDK для .NET**](net-standard-ingest-data.md) | Поддерживаются все форматы | 1 ГБ без сжатия (см. Примечание) | Пакетирование, потоковая передача, прямой | Написание собственного кода в соответствии с потребностями Организации |
