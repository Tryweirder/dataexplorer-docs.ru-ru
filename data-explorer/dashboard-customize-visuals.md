...
|---------|---------|-----|
|**Общие**    |    Выберите формат диаграммы с **накоплением** или **без накопления**  | Линейчатые, гистограммы и диаграммы с областями |
...
|**Ось X**     |    Позволяет настраивать свойства оси X: <ul><li>**Метка**: текст для пользовательской метки. </li>     | Линейчатые диаграммы, гистограммы, области, графики, точечные, аномалии и график времени|
