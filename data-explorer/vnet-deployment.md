...
| **Использование**   | **Источник** | **Тег службы источника** | **Диапазоны исходных портов**  | **Назначение** | **Диапазоны портов назначения** | * * Протокол * * | **Действие** | * * Приоритет * * |
| ---   | --- | --- | ---  | --- | --- | --- | --- | --- |
...
| Name (Имя) | Префикс адреса | Следующий прыжок |
| --- | --- | --- |
