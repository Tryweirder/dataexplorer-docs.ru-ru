...
| Центральная часть США (DoD) | 13.72.37.111 |
| Восточная часть США (DoD) | 13.72.37.111 |
| USGov (Аризона) | 13.72.37.111 |
| USGov (Техас) | 13.72.37.111 |
| USGov (Вирджиния) | 13.72.37.111 |
...
| ---   | --- | --- | ---  | --- | --- | --- | --- | --- |
| Отключить доступ из Интернета | Тег службы | Internet | *  | VirtualNetwork | * | Любой | Запрет | большее число, чем приведенные выше правила |
