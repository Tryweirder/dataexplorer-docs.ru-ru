...
* Субъект-служба Azure Active Directory (Azure AD), которая разрешает просматривать данные в обозреватель данных Azure, включая идентификатор клиента и секрет клиента.
    ...
    Рекомендуется использовать субъект-службу с разрешением на просмотр и запретить использование разрешений более высокого уровня. [Задайте разрешения на просмотр кластера для субъекта-службы Azure AD](https://docs.microsoft.com/azure/data-explorer/manage-database-permissions#manage-permissions-in-the-azure-portal).
...
1. В строке запроса можно выполнять поиск по следующим данным:
    ...
    * Ввод условия поиска.
    * Использование синтаксиса запроса Lucene. Например:
