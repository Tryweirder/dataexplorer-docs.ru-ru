...
Убедитесь, что у вас есть соответствующие разрешения. Для удаления или переименования базы данных требуется роль *Участник* или *Владелец* в подписке Azure. При необходимости обратитесь к администратору подписки, чтобы он добавил вас к соответствующей роли. Можно также удалить или переименовать базу данных, если у вас есть роль *администратора базы данных* .
...
* [Управление разрешениями базы данных](manage-database-permissions.md)
