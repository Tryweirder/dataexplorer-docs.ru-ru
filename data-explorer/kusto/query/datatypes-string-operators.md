...
Например, в следующем операторе `string`терминами являются `Kusto`, `WilliamGates3rd`и следующие подстроки: `ad67d136`, `c1db`, `4f9f`, `88ef`, `d94f3b6b0b5a`.

```
Kusto: ad67d136-c1db-4f9f-88ef-d94f3b6b0b5a;;WilliamGates3rd
```

Kusto создает индекс термина, состоящий из всех терминов, *которые составляют четыре или более символов*, и этот индекс используется `has`, `!has`и т. д. Если запрос ищет термин, который содержит менее четырех символов или использует оператор `contains`, Kusto продолжит проверять значения в столбце, если не сможет определить соответствие. Этот метод намного медленнее, чем поиск термина в индексе термина.
