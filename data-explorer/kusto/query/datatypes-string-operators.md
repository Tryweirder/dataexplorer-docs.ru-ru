...
ms.locfileid: "87803681"
---
# <a name="string-operators"></a>Строковые операторы

Kusto предлагает различные операторы запросов для поиска строковых типов данных. В следующей статье описывается индексация строковых терминов, список операторов строкового запроса и приводятся советы по оптимизации производительности.
