...
Это расширение по сравнению с JSON недоступно при синтаксическом анализе строк (например, при использовании `parse_json` функции или при приеме данных), но это позволяет сделать следующее:
...
|Выражение                        | Тип выражения доступа | Значение                                                                              | Примечания                                      |
|----------------------------------|--------------------------|--------------------------------------------------------------------------------------|-----------------------------------------------|
...
|тоинт (X [1])|101| int|
| Д | parse_json ("{" a1 ": 100," a b c ":" 2015-01-01 "}")| словарь|
