---
title: Функция format_datetime () в Azure Data Explorer
description: В этой статье описывается функция format_datetime() в Azure Data Explorer.
...
|`tt`   |Часы до и после полудня |2009-06-15T13:45:09 -> после полудня

**Поддерживаемые разделители**

Описатель формата может включать в себя следующие символы разделителей:
