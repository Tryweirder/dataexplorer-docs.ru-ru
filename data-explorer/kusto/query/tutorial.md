...
> Совет. в клиенте Kusto не ставьте пустые строки между частями этого объекта. Обязательно выполните все части.
...
> Примечание. Если кластер указан, база данных является обязательной.
