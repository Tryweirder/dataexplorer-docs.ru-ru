...
ms.locfileid: "91452886"
---
# <a name="geo_distance_point_to_line"></a>geo_distance_point_to_line()

Вычисляет самое короткое расстояние между координатой и линией или многострочным на земле.
...
:::image type="content" source="images/geo-distance-point-to-line-function/us-south-coast-storm-events.png" alt-text="Расстояние между аэропортами и поездками Северной Лас":::
...
Повышена отправке в такси. Раскладки фильтруются по максимальному расстоянию 0,1 метров от определенного многострочного.

:::image type="content" source="images/geo-distance-point-to-line-function/madison-ave-road.png" alt-text="Расстояние между аэропортами и поездками Северной Лас":::
