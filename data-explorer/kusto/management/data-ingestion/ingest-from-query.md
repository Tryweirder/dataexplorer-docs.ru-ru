...
Создайте новую таблицу с именем :::no-loc text="RecentErrors"::: в базе данных, которая имеет ту же схему, что :::no-loc text="LogsTable"::: и, и содержит все записи об ошибках за последний час.
