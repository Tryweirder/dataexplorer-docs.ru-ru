...
**Сбои при экспорте команды**

* Во время выполнения команда экспорта может быть неустранима. При сбое команды экспорта артефакты, которые уже были записаны в хранилище, не удаляются. Эти артефакты будут храниться в хранилище. Если команда завершается неудачно, предположим, что экспорт неполон, даже если были записаны некоторые артефакты. Самый лучший способ отследить завершение команды и артефакты, экспортированные после успешного завершения, — с помощью команд [. показывать операции](../operations.md#show-operations) и [. Показывать подробности операции](../operations.md#show-operation-details) .
