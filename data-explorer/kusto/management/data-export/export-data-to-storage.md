...
* [`.show operations`](../operations.md#show-operations): Отслеживать ход выполнения.
* [`.show operation details`](../operations.md#show-operation-details): Получение результатов выполнения.
...
* Лучший способ отследить завершение команды и артефакты, экспортированные после успешного завершения, — с помощью [`.show operations`](../operations.md#show-operations) команд и [`.show operation details`](../operations.md#show-operation-details) .
