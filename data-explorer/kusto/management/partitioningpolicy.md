...
* **Еффективедатетиме**:
  ...
  * **Примечание.** Можно задать значение DateTime в прошлом и получить этот результат с уже полученными данными для секционирования.
    Однако это может значительно увеличить использование ресурсов в процессе секционирования, и вы должны учитывать преимущества этого процесса.
