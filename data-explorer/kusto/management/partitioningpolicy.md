...
* **Максровкаунтпероператион**:
  ...
  * Это необязательное свойство. Значение по умолчанию — `0` , а целевой объект по умолчанию — 5 000 000 записей.
    * Можно установить значение ниже, чем 5 мин. Вы увидите, что операции секционирования потребляют очень большой объем памяти или ЦП, на операцию (см. #monitoring).
