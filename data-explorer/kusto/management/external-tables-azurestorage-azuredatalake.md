...
| `sampleUris`     | `bool`   | Если параметр задан, в результате выполнения команды предоставляется несколько примеров URI внешних файлов данных, так как они ожидаются определением внешней таблицы. |
