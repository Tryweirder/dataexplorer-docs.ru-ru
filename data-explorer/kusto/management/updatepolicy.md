...
ms.locfileid: "87803422"
---
# <a name="update-policy-overview"></a>Обзор политики обновления

[Политика обновления](update-policy.md) указывает Kusto автоматически добавлять данные в целевую таблицу при вставке новых данных в исходную таблицу. Запрос политики обновления выполняется для данных, вставленных в исходную таблицу. Например, политика позволяет создать одну таблицу с отфильтрованным представлением другой таблицы. Новая таблица может иметь другую схему, политику хранения и т. д. 
