...
> * В области запроса автоматически рассматриваются только вновь полученные записи.
> * Каскадные обновления разрешены (таблица a--`[update]`--> TableB--`[update]`--> TableC--`[update]`-->...)
