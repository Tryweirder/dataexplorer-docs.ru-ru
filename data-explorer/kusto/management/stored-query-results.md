...
Для использования результатов сохраненного запроса требуется `Database User` или более высокая роль доступа.
...
`Database User` для вызова этой команды требуется разрешение.
