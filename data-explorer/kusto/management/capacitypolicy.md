...
> [!Note]
> * `MaximumConcurrentOperationsPerNode`автоматически корректируется системой в диапазоне [1, 5]
...
> [!Note]
> `ClusterMaximumConcurrentOperations`автоматически корректируется системой в диапазоне [1, 10]
