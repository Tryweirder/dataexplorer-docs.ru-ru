...
Эффективное значение для `Concurrent operations` получается автоматически в соответствии с системой в диапазоне [ `ClusterMinimumConcurrentOperations` , `ClusterMaximumConcurrentOperations` ].
