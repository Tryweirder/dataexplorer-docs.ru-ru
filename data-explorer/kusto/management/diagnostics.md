...
|тоталоригиналдатасизе|Int64|Общий размер изначально полученных данных в байтах
|тоталекстентсизе|Int64|Общий размер сохраненных данных после сжатия и индексирования в байтах
...
|Status |Строка |Дополнительная строка справки, содержащая ошибки для неудачных операций
 
**Пример**
 
|ID |Операция |идентификатор узла; |Начато |Последнее обновление |Длительность |Состояние |Status 
|--|--|--|--|--|--|--|--
