...
* Переключитесь на API .NET v2, чтобы команда Kusto могла понять, если вы выпустили эту ошибку, поэтому мы можем повысить приоритет клиента потоковой передачи.
