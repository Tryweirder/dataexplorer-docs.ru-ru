...
* `materialized_view_shuffle` (*Оптионматериализедвиевшуффлекуери*): указание использовать стратегию случайного использования для материализованных представлений, на которые имеются ссылки в запросе.
