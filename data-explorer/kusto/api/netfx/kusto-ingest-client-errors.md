...
|-----------|---------|------------------------------|
|Error      | Тип String  | Ошибка, возникшая при попытке получить очереди из DM
...
|Имя поля   |Тип     |Значение       
|-------------|---------|------------------------------|
|кустоендпоинт| Тип String  | Конечная точка соответствующего DM
...
|Имя поля   |Тип     |Значение       
|-------------|---------|------------------------------------|
|PropertyName | Тип String  | Имя повторяющегося свойства
...
|Имя поля   |Тип     |Значение       
|-------------|---------|---------------------------------|
|куеуеури     | Тип String  | URI очереди
|Error        | Тип String  | Сообщение об ошибке, созданное при попытке публикации в очереди
