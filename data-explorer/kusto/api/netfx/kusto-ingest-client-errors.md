...
Полный список кодов ошибок приема см. [в разделе Коды ошибок приема в Azure обозреватель данных](../../../error-codes.md).
...
|-----------|---------|------------------------------|
|Ошибка      | Строка  | Ошибка, возникшая при попытке получить очереди из DM
...
|Ошибка        | Строка  | Сообщение об ошибке, созданное при попытке публикации в очереди
